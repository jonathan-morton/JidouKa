...
import dev.jidouka.common.network.serializers.EventResponseSerializer
import dev.jidouka.common.network.serializers.MessageBaseSerializer
import dev.jidouka.common.network.serializers.ResultResponseSerializer
...
public sealed class MessageBase {
    ...
    @SerialName("type")
    internal abstract val messageType: MessageType
}
...
public sealed class HaRequest : MessageBase() {

    @Serializable
    internal data class SubscribeTriggerRequest(
        override val id: Int,
        @SerialName("trigger")
    ...
    @Serializable
    internal data class SubscribeEventsRequest(
        override val id: Int,
    ...
    @Serializable
    internal data class UnsubscribeEventsRequest(
        override val id: Int,
    ...
    @Serializable
    internal data class CallServiceActionRequest(
        override val id: Int,
        @SerialName("domain")
        val domain: String,
        @SerialName("service")
    ...
    @Serializable
    public data class GetStatesRequest(
        override val id: Int
    ) : HaRequest() {
        @SerialName("type")
...
@Serializable
public sealed class HaResponse : MessageBase() {
    @Serializable
...
public sealed class ResultResponse : HaResponse() {
    public abstract val success: Boolean
...
internal sealed class EventResponse : HaResponse() {
    ...
    @Serializable
    public data class TriggerEventResponse(
        override val id: Int,
        @SerialName("event")
