...
package dev.jidouka.common.extensions
...
internal fun KLogger.debugF(message: () -> String) {
...
internal fun KLogger.infoF(message: () -> String) {
...
internal fun KLogger.warnF(message: () -> String) {
...
internal fun KLogger.warnF(exception: Throwable, message: () -> String) {
    if (isLoggingEnabledFor(Level.WARN)) {
        val method = callerMethod()
...
internal fun KLogger.errorF(message: () -> String) {
...
internal fun KLogger.errorF(exception: Throwable, message: () -> String) {
    if (isLoggingEnabledFor(Level.ERROR)) {
        val method = callerMethod()
...
internal fun KLogger.traceF(message: () -> String) {
